(() => {
  ...
  var isEmpty = /* @__PURE__ */ all2(function(v) {
    return function(v1) {
      return false;
    };
  });
  ...
  var snoc4 = function(cat) {
    return function(a2) {
      return append2(cat)(new CatCons(a2, empty3));
    };
  };
  ...
  var substFree = function(k) {
    var go2 = function(f) {
      ...
      if (v instanceof Bind) {
        return bind3(k(v.value0))(map9(go2)(v.value1));
      }
      ;
  ...
  var eqInterpretHookReason = {
    eq: function(x) {
      return function(y) {
        ...
        ;
        if (x instanceof Step2 && y instanceof Step2) {
          return true;
        }
        ;
  ...
  var stepIndex = function(index4) {
    return function(array) {
      var $88 = (index4 + 1 | 0) < length3(array);
      if ($88) {
        return index4 + 1 | 0;
      }
      ;
      ...
      return function(_evalHook) {
            ...
            return bind6(_evalHook(reason))(function() {
              ...
              return discard1(when2(!$$null(v.evalQueue))(function() {
                ...
                return discard1(runQueue)(function() {
                  ...
                  var initializeOrStepReason = eq2(reason)(Initialize2.value) || eq2(reason)(Step2.value);
                  return when2(v1.stateDirty && initializeOrStepReason)($$void5(executeHooksAndEffects(stateRef)(Step2.value)));
                });
              }()))(function() {
        ...
        return function(v) {
          ...
          if (v instanceof Query) {
            return bind6(get2)(function(v1) {
              ...
              if (v2.queryFn instanceof Nothing) {
                return pure12(v.value1(unit));
              }
              ;
              if (v2.queryFn instanceof Just) {
                return _evalHookM(executeHooksAndEffects(v1.stateRef)(Step2.value))(unCoyoneda(function(g) {
          ...
          if (v instanceof Action2) {
            return bind6(get2)(function(v1) {
              return discard1(_evalHookM(executeHooksAndEffects(v1.stateRef)(Step2.value))(v.value0))(function() {
                return pure12(v.value1);
              });
            });
          }
          ;
            ...
            return bind6(get2)(function(v1) {
              ...
              return discard1(unless2(inputEq(v2.input)(v.value0))(function() {
                var execute = unsafePerformEffect(function __do2() {
                  ...
                  return executeHooksAndEffects(v1.stateRef)(Step2.value);
                });
        ...
        return function(stateRef) {
          return function(v) {
            ...
            if (v instanceof UseEffect) {
              if (reason instanceof Initialize2) {
                return pure23(unsafePerformEffect(/* @__PURE__ */ function() {
                  var $$eval = function(index4) {
                    return bind6(_evalHookM(_evalHook(Queued.value))(v.value1))(function(mbFinalizer) {
                      ...
                      return pure12(unsafePerformEffect(modify_(function(s) {
                        return {
                          effectCells: {
                  ...
                  if (v.value0 instanceof Just && v2.value0 instanceof Just) {
                    ...
                    if ($171) {
                      var $$eval = bind6(_evalHookM(_evalHook(Queued.value))(applySecond2(v2.value1)(v.value1)))(function(mbFinalizer) {
                        ...
                        return pure12(unsafePerformEffect(modify_(function(v4) {
                          return {
                            effectCells: {
                              queue: newQueue,
  ...
  var unsubscribe4 = function(sid) {
    return function(ref2) {
      return function __do2() {
        ...
        return traverse_3(unsubscribe)(bindFlipped5(lookup4(sid))(subs))();
      };
    };
  };
            ...
            if (v1 instanceof Subscribe) {
              return bind14(fresh(SubscriptionId)(ref2))(function(sid) {
                return bind14(liftEffect4(subscribe(v1.value0(sid))(function(act) {
                  ...
                  return bind14(liftEffect4(read(ref2)))(function(v2) {
                    return discard12(liftEffect4(modify_(map23(insert3(sid)(finalize)))(v2.subscriptions)))(function() {
  ...
  var runUI2 = function(component2) {
    return function(i2) {
      return function(element3) {
        return bind16(liftEffect6(map17(toDocument)(bindFlipped7(document)(windowImpl))))(function(document2) {
  ...
  var hookComponent = /* @__PURE__ */ component(function(v) {
    return function(v1) {
      return bind5(useState(0))(function(v2) {
        return pure5(div_([button([onClick(function(v3) {
          return modify_3(v2.value1)(function(v4) {
            return v4 - 1 | 0;
          });
        })])([text5("-")]), div_([text5(show2(v2.value0))]), button([onClick(function(v3) {
          return modify_3(v2.value1)(function(v4) {
            return v4 + 1 | 0;
          });
        })])([text5("+")])]));
  ...
  var main2 = /* @__PURE__ */ runHalogenAff(/* @__PURE__ */ bind(bindAff)(awaitBody)(function(body2) {
    return $$void8(runUI2(hookComponent)(Nothing.value)(body2));
  }));
