...
/* package verctors-0.1.0.0 */
#ifndef VERSION_verctors
#define VERSION_verctors "0.1.0.0"
#endif /* VERSION_verctors */
#ifndef MIN_VERSION_verctors
#define MIN_VERSION_verctors(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_verctors */
...
#define CURRENT_COMPONENT_ID "verctors-0.1.0.0-inplace-verctors"
