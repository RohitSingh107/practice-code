...
myBrowser :: String
myBrowser = "epiphany "  -- Sets qutebrowser as browser
...
myStartupHook = do
    ...
    spawnOnce "feh --randomize --bg-fill /home/rohit/Pictures/wallpapers/0258.jpg"
...
myWebGrid = [ ("Epiphany", "epiphany")
                 ...
                 , ("Discord", "discord")
                 , ("Google Chrome (Don't use it)", "google-chrome-stable")
